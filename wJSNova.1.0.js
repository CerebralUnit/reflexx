...
(function($)
{
	...
	JSNova.prototype = 
	{
		...
		generate: function()
		{
			...
			.append(
				$('<div id="MySplitter" class="" cellpadding="0" cellspacing="1"></table>')
					.append(
						$('<div class="top"></div>')
							.append(
								$('<div class="container" id="MySplitter2"></div>')
									.append(
										$('<div class="box "></div>')
										.append(
					...
					.append(
						...
						.append(
							$('<div class="container" id="MySplitter3"></div>')
								.append(
									$('<div class="box"></div>')
									.append(
										$('<div class="boxContainer"></div>')
								...
								.append(
									$('<div class="_wJSNova_box _wJSNova_boxBottom _wJSNova_boxRight"></div>')
									.append(
